...
const BeMyValentine = () => {
	...
	const [counterArray, setCounterArray] = useState([
		...
		},
		{
			...
			yesButtonSizeLarge: 'py-9 px-[4.5rem] text-3xl z-10',
		...
		},
		{
			...
			yesButtonSizeLarge: 'py-10 px-20 text-4xl z-10',
		...
		},
		{
			...
			yesButtonSizeLarge: 'py-11 px-[5.5rem] text-5xl z-10',
		...
		},
		{
			...
			yesButtonSizeSmall: 'py-8 px-16 text-4xl z-10',
			yesButtonSizeLarge: ' py-12 px-24 text-6xl z-10',
		...
		},
		{
			...
			yesButtonSizeLarge: ' py-13 px-[6.5rem] text-7xl z-10',
		...
		},
		{
			...
			yesButtonSizeLarge: 'py-14 px-28 text-8xl z-10',
